...
interface PageInterface
{
     ...
     * @return PageInterface
     */
    public function addAnnotation(Annotation\AbstractAnnotation $annotation, int|float $x = 0, int|float $y = 0): PageInterface;
     ...
     * @return PageInterface
     */
    public function addUrl(Annotation\Url $url, int|float $x = 0, int|float $y = 0): PageInterface;
     ...
     * @return PageInterface
     */
    public function addLink(Annotation\Link $link, int|float $x = 0, int|float $y = 0): PageInterface;
