...
/**
 * Pdf extract StandardEncoding table class
 *
 * Only the ASCII range (0x20-0x7E) is populated - StandardEncoding's upper
 * byte range (0x80-0xFF) differs from Latin-1/WinAnsi in specific,
 * non-contiguous ways this project doesn't have a verified reference table
 * for; those bytes are intentionally left unmapped rather than guessed at.
 *
 * Per Adobe's StandardEncoding (PDF spec Annex D), codes 0x27 and 0x60 are
 * quoteright (U+2019) and quoteleft (U+2018) respectively, not the plain
 * ASCII apostrophe/backtick - a well-known deviation from the rest of the
 * ASCII range that this table honors.
 *
 * @category   Pop
 * @package    Pop\Pdf
 * @author     Nick Sagona, III <nick@popphp.org>
...
class StandardEncoding
{
    ...
    /**
     * StandardEncoding byte-to-Unicode codepoint table
     */
    public const TABLE = [
        0x20 => 0x0020, 0x21 => 0x0021, 0x22 => 0x0022, 0x23 => 0x0023, 0x24 => 0x0024,
        0x25 => 0x0025, 0x26 => 0x0026, 0x27 => 0x2019, 0x28 => 0x0028, 0x29 => 0x0029,
        ...
        0x5C => 0x005C, 0x5D => 0x005D, 0x5E => 0x005E, 0x5F => 0x005F, 0x60 => 0x2018,
