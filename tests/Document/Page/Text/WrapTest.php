...
class WrapTest extends TestCase
{
    ...
    {
        $wrap = Text\Wrap::createLeft(50, 550, ['left' => 300, 'right' => 550, 'top' => 732, 'bottom' => 580]);
    ...
    {
        $wrap = Text\Wrap::createRight(50, 550, ['left' => 50, 'right' => 300, 'top' => 732, 'bottom' => 580]);
        $this->assertTrue($wrap->isRight());
    }

    public function testSetBoxCoordinates()
    {
        $wrap = Text\Wrap::createRight(50, 550);
    ...
    public function testSetBoxException()
    {
        ...
        $wrap = Text\Wrap::createRight(50, 550, ['left' => 50, 'right' => 300, 'bad' => 732]);
    }
