...
class AlignmentTest extends TestCase
{
    ...
    {
        $alignment = Text\Alignment::createCenter(50, 550, 10);
        $this->assertInstanceOf('Pop\Pdf\Document\Page\Text\Alignment', $alignment);
        $this->assertEquals(Text\Alignment::CENTER, $alignment->getAlignment());
    ...
    {
        $alignment = Text\Alignment::createLeft(50, 550, 10);
        $this->assertTrue($alignment->isLeft());
    }

    public function testCreateRight()
    {
        $alignment = Text\Alignment::createRight(50, 550, 10);
    ...
    public function testGetStrings()
    {
        ...
        $alignment = Text\Alignment::createCenter(50, 550);
    ...
    public function testGetStringsRight()
    {
        ...
        $text      = new Text($string, 10);
        $arial     = new Font('Arial');
        $alignment = Text\Alignment::createRight(50, 550);
        $strings   = $alignment->getStrings($text, $arial, 732);
    ...
    public function testGetStringsLeft()
    {
        ...
        $text      = new Text($string, 10);
        $arial     = new Font('Arial');
        $alignment = Text\Alignment::createLeft(50, 550);
        $strings   = $alignment->getStrings($text, $arial, 732);
